...
def predict_loan():
    ...
    amount_term = int(request.form.get('loanterm'))
    ...
    print(gender, married, dependents, education, self_employed, amount_term, credit, parea, loanamount, totalincome)

    data = np.array([[gender, married, dependents, education, self_employed,
                      amount_term, credit, parea, loanamount, totalincome]])
